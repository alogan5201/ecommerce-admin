...
const kLocalRoot = "http://localhost:8080/ecommerce_admin2/";
...
/* -- Firebase Config */
const firebaseStoragePath="userprofile";
const firebaseUseExtendedUserData="false";
const firebaseUserCollection="";
const firebaseAnonymous=false;
const firebaseAllowRegister=true;
const firebaseFbAuth=false;
const firebaseGoogleAuth=false;
const firebaseTwitterAuth=false;
try {
   var firebaseConfig = { 
        apiKey: "AIzaSyATkQjW_oDB9Xkf9GmZu0PHFn5esbqy0-w",
    authDomain: "loyalty-program-94c4a.firebaseapp.com",
    databaseURL: "https://loyalty-program-94c4a-default-rtdb.firebaseio.com",
    projectId: "loyalty-program-94c4a",
    storageBucket: "loyalty-program-94c4a.appspot.com",
    messagingSenderId: "942079893959",
    appId: "1:942079893959:web:93fda79a5d18998e0c79e2"
    };
 } catch (error) {
   console.error(error);
   window.status = '{2} Firebase API Key: ' + error;
}
/* -- Firebase Config */
...
{
    path: '/productdetail/',
    url: './pages/productdetail.html?r=36366',
    name: 'productdetail',
},
{
    path: '/newproduct/',
    url: './pages/newproduct.html?r=97164',
    name: 'newproduct',
},
{
    path: '/history/',
    url: './pages/history.html?r=60854',
    name: 'history',
},
{
    path: '/orderdetail/',
    url: './pages/orderdetail.html?r=16438',
    name: 'orderdetail',
},
{
    path: '(.*)',
